...
// module.exports = { updatedImages, getImages,cloudinaryUploadImage,cloudinary };
...
const cloudinaryUploadImage = async (fileToUpload, folderName) => {
  console.log("cloudinaryUploadImage called with:", fileToUpload, folderName);
  try {
    const data = await cloudinary.uploader.upload(fileToUpload, {
      folder: folderName || "general",
      resource_type: "auto",
...
module.exports = { cloudinary, cloudinaryUploadImage };
